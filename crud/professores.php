<html>
    ...
    <head>
        ...
        <meta autor="Vinko Vicenzo Tomljanovie">
        ...
        <div class="container-fluid">
            ...
            <form name="form-professor" method="POST" action="?acao=salvar">
                ...
                <div class="input-group mb-2">
                    ...
                    <input type="text" class="form-control" id="nome-professor" name="nome-professor" required value="<?php echo $professor->getNome() ?>">
                </div>
